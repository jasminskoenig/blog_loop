...
Below, we implemented an interactive tool that lets users choose between 3 different data sets on populism to explore the constitutional changes and their effect on different indices of democratic quality in a variety of countries.
...
```{=html}
<iframe width="100%" height="799" frameborder="0"
  src="https://observablehq.com/embed/8d3cd6452ab1e67e@479?cells=viewof+source%2Cviewof+Dataset%2Cviewof+Vars%2Cprint%2Cplotfinal&api_key=b7dc8c92e8fbf2b2c4a595241af7f48a1ac2c70c"></iframe>
```
