...
ds <- tibble(
  name = c("V-Party", "PopuList", "Ruth-Lovell/Grahn"),
  value1 = c("a", "b", "c"),
  value2 = c("d", "e", "f"),
  value3 = c("g", "h", NA)
  )

write.csv(ds, "data/ds.csv")
...
Populism in government and implementation in law. We know salient cases, but don't now that much more. They are also RRP, and not only populist. Look at judicial reviews -> Link to our other paper.
